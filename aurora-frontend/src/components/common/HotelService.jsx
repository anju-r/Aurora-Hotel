            ...
            <Container className="mb-2">
                ...
                <Row>
                    <h4 className="text-center">
                        Services at <span className="hotel-color"> Aurora </span> Hotel
                        <span className="gap-2">
                            <FaClock> - 24 Hour Front Desk</FaClock>
                        </span>
                    </h4>
                </Row>
                <hr />
                    ...
                    <Col>
                        <Card>
                            <Card.Body>
                                ...
                                <Card.Text>Enjoy a refreshing drink or snack from our inn-room mini-bar.</Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
